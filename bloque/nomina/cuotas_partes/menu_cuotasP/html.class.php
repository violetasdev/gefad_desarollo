    ...
    class html_menuReporteFin {
        ...
        <body>
		    ...
		    <li><a href="#s1">Presupuesto</a>
				    ...
				    <li><a href="<? $variable = 'pagina=cuentaCobro'; $variable.='&opcion='; $variable = $this->cripto->codificar_url($variable, $this->configuracion);
		   			        echo $this->indice . $variable; ?>">Cuenta de Cobro (beta)</a></li>
                                </ul>
                            </li>
