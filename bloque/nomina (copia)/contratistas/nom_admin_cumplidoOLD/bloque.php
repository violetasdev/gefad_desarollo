...
class bloqueAdminNovedad extends bloque
{
	...
	{
 		$this->sql = new sql_adminCumplido();
 		$this->funcion = new funciones_adminCumplido($configuracion, $this->sql);
		...
		{ 
			case 'verificar':
				...
				break;
		  		...
		  		//solicitar cumplido
				$this->funcion->revisarSolicitudCumplido($configuracion);
				break;
...
$esteBloque = new bloqueAdminNovedad($configuracion);
