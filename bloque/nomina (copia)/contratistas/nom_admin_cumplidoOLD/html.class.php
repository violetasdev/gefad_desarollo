                        ...
                        <tr align='center'>
                                <td colspan='2' rowspan='1'>
                                    <br>
                                        ...
                                        <!--<input type='hidden' name='action' value='nom_admin_cumplido'>-->
                                        <input type='hidden' name='pagina' value='nom_adminCumplido'>
                        ...
                        <tr align='center'>
                                <td colspan='2' rowspan='1'>
                                    <br>
                                        ...
                                        <input type='hidden' name='mes_cumplido' value='<? echo $mes_cumplido?>'>
                                                                                        ...
                                                                                        if(is_array($registro )){
                                                                                            foreach ($registro as $key => $value)
                                                                                                {                                                                                               
                                                                                                        ...
                                                                                                        $finicio_cumplido =  (isset($registro[$key]['finicio_contrato'])?$registro[$key]['finicio_cumplido']:'');
                                                                                                        $ffinal_cumplido =  (isset($registro[$key]['ffinal_contrato'])?$registro[$key]['ffinal_cumplido']:'');
