			...
			?>
                        ...
                        <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <input align="center"type=image src="<? echo $this->configuracion['site'] . $this->configuracion['grafico']; ?>/cal.png" name="btnFecha" id="btnFecha" >
                        ...
                        <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <input align="center"type=image src="<? echo $this->configuracion['site'] . $this->configuracion['grafico']; ?>/cal.png" name="btnFechaFin" id="btnFechaFin" >
                                    ...
                                    <table class='bordered'>
                                        ...
                                        <tr>
                                                <td width='20%' class="texto_elegante estilo_td"><?
                                                        ...
                                                        ?>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Banco:</span>
                                                </td>
                                                <td>
                                                        <?
                                                        echo $lista_bancos;
                                        ...
                                        <tr>
                                                <td width='20%' class="texto_elegante estilo_td"><?
                                                        ...
                                                        ?>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">No. Cuenta:</span>
                                                </td>
                                                <td>
                                                        <input type='text' name='num_cta' value='<?if($num_cta) echo $num_cta; ?>' size='25' maxlength='15' tabindex='<? echo $tab++ ?>' oncontextmenu='return false;'  onKeyPress="return solo_numero_sin_slash(event)" >
                                        ...
                                        <tr>
                                                <td width='20%' class="texto_elegante estilo_td"><?
                                                        ...
                                                        ?>&nbsp;<span onmouseover="return escape('<? echo $texto_ayuda?>')">Tipo Cuenta:</span>
                                                </td>
                                                <td>
                                                        <?
                                                        echo $lista_tipo_cta;
                        ...
                        <tr align='center'>
                                <td colspan='2' rowspan='1'>
                                    <br>
                                        ...
                                        <input type='hidden' name='interno_prov' value='<? echo $interno_prov?>'>
                                        <input type='hidden' name='interno_oc' value='<? echo $interno_oc?>'>
                                        <input type='hidden' name='cod_contratista' value='<? echo $cod_contratista?>'>
                                        <input type='hidden' name='tipo_id' value='<? echo $tipo_id_contratista?>'>
                                        <input type='hidden' name='vigencia' value='<? echo $vigencia?>'>
                                        <input type='hidden' name='unidad_ejec' value='<? echo $unidad_ejec?>'>
                            ...
                            <td colspan='2' rowspan='1' align="center">
                                <br>
                                   <input type='hidden' name='action' value='nom_admin_novedad'>
                                    ...
                                    <input value="Buscar" name="buscar_vigencia" tabindex="<?= $tab++ ?>" type="button" onclick="document.forms['<? echo $this->formulario?>'].submit()">
                            </td>
                    </tr>
                    </table>
                </form>
