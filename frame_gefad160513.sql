...
--
-- Servidor: localhost
-- Tiempo de generación: 16-05-2013 a las 15:01:01
...
('oracleSIC', 'oci8', '10.20.0.156', 1521, '', 'PRUEBA_SIC', 'WAOMCf26iFEwnJ1IZ4QgUQ', 'XAM9X_26iFEPBEvJ7II'),
...
('8', 'Salida del sistema.', '1367875097'),
('8', 'Salida del sistema.', '1367895073'),
('8', 'Salida del sistema.', '1367959812'),
('8', 'Salida del sistema.', '1368033026'),
('8', 'Salida del sistema.', '1368034046'),
('8', 'Salida del sistema.', '1368560632'),
('8', 'Salida del sistema.', '1368560820'),
('8', 'Salida del sistema.', '1368630120'),
('8', 'Salida del sistema.', '1368652964'),
('8', 'Salida del sistema.', '1368659417'),
('8', 'Salida del sistema.', '1368723800'),
('8', 'Salida del sistema.', '1368726686'),
('8', 'Salida del sistema.', '1368732828');
...
(1, 1, 'unidad', 'consulta que carga los valores para los parametros de unidad ejecutora, el el reporte de reservas.', 'oracleSIC', 'SELECT DISTINCT codigo cod_un, descripcion nombre_ud FROM pr.pr_unidad_ejecutora WHERE codigo_compania=''230'' and codigo $P{''unidad''}', 1, 'vigencia', 'unidad', 'combo', 'unidad'),
...
(1, 4, 'unidad', 'consulta que carga los valores para los parametros de unidad ejecutora, el el reporte de reservas.', 'oracleSIC', 'SELECT DISTINCT codigo cod_un, descripcion nombre_ud FROM pr.pr_unidad_ejecutora WHERE codigo_compania=''230'' and codigo $P{''unidad''}', 1, 'vigencia', 'unidad', 'combo', 'unidad'),
...
(1, 5, 'unidad', 'consulta que carga los valores para los parametros de unidad ejecutora, el el reporte de registros.', 'oracleSIC', 'SELECT DISTINCT codigo cod_un, descripcion nombre_ud FROM pr.pr_unidad_ejecutora WHERE codigo_compania=''230''', 1, 'vigencia', 'unidad', 'combo', 'unidad'),
...
(1, 9, 'unidad', 'consulta que carga los valores para los parametros de unidad ejecutora, el el reporte de disponibilidades presupuestales.', 'oracleSIC', 'SELECT DISTINCT codigo cod_un, descripcion nombre_ud FROM pr.pr_unidad_ejecutora WHERE codigo_compania=''230'' and codigo $P{''unidad''}', 1, 'vigencia', 'unidad', 'combo', 'unidad'),
...
--
-- Volcado de datos para la tabla `gestion_valor_sesion`
--

INSERT INTO `gestion_valor_sesion` (`id_sesion`, `variable`, `valor`, `expiracion`, `id_usuario`) VALUES
('88fefd031083e5617f1a50af4fb66bd4', 'identificacion', '79812212', '', ''),
('88fefd031083e5617f1a50af4fb66bd4', 'acceso', '5', '', ''),
('88fefd031083e5617f1a50af4fb66bd4', 'expiracion', '1368735843', '', ''),
('88fefd031083e5617f1a50af4fb66bd4', 'usuario', 'Jairo', '', ''),
('88fefd031083e5617f1a50af4fb66bd4', 'id_usuario', '8', '', '');
